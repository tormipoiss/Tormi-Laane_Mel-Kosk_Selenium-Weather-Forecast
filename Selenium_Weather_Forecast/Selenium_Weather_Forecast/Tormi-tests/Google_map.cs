...
namespace Selenium_Weather_Forecast.Tormi_tests
{
    internal class Google_map
    {
        ...
        public void Test()
        {
            ...
            IWebElement googleMapSpan = driver.FindElement(By.Id("googlemapSpan"));

            Actions actions = new Actions(driver);
            actions.ScrollToElement(googleMapSpan);
            actions.Perform();

            googleMapSpan.Click();

            IWebElement iframe = driver.FindElement(By.Id("googlemap"));
            ...
            driver.FindElement(By.Id("googlemapSpan")).Click();
