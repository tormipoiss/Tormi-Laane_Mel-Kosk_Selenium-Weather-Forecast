...
{
    internal class Multiple_day_search_in_past
    {
        IWebDriver driver;
        [SetUp]
        ...
        public void Test()
        {
            ...
            Assert.That(wait.Until(ExpectedConditions.TextToBePresentInElementLocated(By.XPath("//p[text()='Cannot forecast weather in the past, defaulted to today']"), "Cannot forecast weather in the past, defaulted to today")));
