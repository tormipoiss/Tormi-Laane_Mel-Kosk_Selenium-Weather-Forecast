...
{
    internal class Forecast_date_in_past
    {
        IWebDriver driver;
        [SetUp]
        ...
        public void Test()
        {
            ...
            DateTime pastDate = currentDate.AddDays(-5);
            ...
            pastDateString = String.Join($"{Keys.Tab}", pastDateString.Split(" "));

            driver.FindElement(By.Id("ForecastDate")).SendKeys(pastDateString);
