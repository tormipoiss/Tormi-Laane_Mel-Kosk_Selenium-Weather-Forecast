...
namespace Selenium_Weather_Forecast.Tormi_tests
{
    internal class Lightning_map
    {
        ...
        public void Test()
        {
            ...
            IWebElement lightningmapSpan = driver.FindElement(By.Id("lightningmapSpan"));

            Actions actions = new Actions(driver);
            actions.ScrollToElement(lightningmapSpan);
            actions.Perform();

            lightningmapSpan.Click();

            IWebElement iframe = driver.FindElement(By.Id("lightningmap"));
            ...
            Assert.That(wait.Until(ExpectedConditions.ElementIsVisible(By.Id("MapDiv"))).Displayed);

            driver.SwitchTo().DefaultContent();

            driver.FindElement(By.Id("lightningmapSpan")).Click();
