...
{
    internal class Search_forecast_error
    {
        IWebDriver driver;
        [SetUp]
        ...
        public void Test()
        {
            ...
            string err = wait.Until(ExpectedConditions.ElementExists(By.CssSelector(".text-danger.field-validation-error"))).Text;
            Assert.That(driver.Url == "https://localhost:5001/Home/City");
            Assert.That(err == "The city name field is required.");
